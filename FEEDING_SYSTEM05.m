...
for i = 2:dt:tb
    ...
    fun = @(x)root3d(x, sum_m_f(i-1), sum_m_ox(i-1), R_tot_f, R_tot_ox, Pt_in_f, Pt_in_ox, V_gas_in_f, V_gas_in_ox, rho_f, rho_ox, c_star(i), A_t, dt);
