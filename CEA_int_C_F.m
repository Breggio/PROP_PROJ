function [p] = CEA_int_C_F(A_e, A_t)
%CEA_INT_C_F This function returns the coefficients of the polynomial that
%evaluates the value of the thrust coefficient thanks to an interpolation
%starting from the CEA code.
%
% PROTOTYPE:
%   [p] = CEA_int_C_F(A_e, A_t)
%
% INPUT:
