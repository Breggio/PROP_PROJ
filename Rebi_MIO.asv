...
L = 0.20; %[m]  MUST BE LOOKED ON SOURCES
...
[R_cooling_f] = cooling_losses(f_D, d_pipe, L, rho_f, A_pipe);
[R_cooling_ox] = cooling_losses(f_D, d_pipe, L, rho_ox, A_pipe);
...
[R_feed_f] = feeding_losses(f_D, rho_f, L, d_pipe);
[R_feed_ox] = feeding_losses(f_D, rho_ox, L, d_pipe);
