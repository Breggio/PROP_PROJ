function [m_dot] = mass_flow_rate(P_gt, P_c, R_feed, R_dyn, R_inj, R_valves)
...
%  R_valves     Pressure drop coefficient due to valve [Pa/(kg^2/s^2)]
%
% OUTPUT:
...
R_sum = R_feed + R_dyn + R_inj + R_valves; % [Pa/(kg^2/s^2)]
